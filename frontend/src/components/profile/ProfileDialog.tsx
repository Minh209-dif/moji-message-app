...
const ProfileDialog = ({ open, setOpen }: ProfileDialogProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="overflow-y-auto max-h-[95vh] p-0 bg-transparent border-0 shadow-2xl sm:max-w-lg">
                <div className="bg-gradient-glass">
                    <div className="max-w-4xl mx-auto p-4">
                        ...
                        {/* Tabs */}
                        <Tabs defaultValue="personal" className="my-4 w-full flex-col">
