...
export function SignupForm({className, ...props}: React.ComponentProps<"div">) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                <a href="/signin" className="mx-auto block w-fit text-center">
                  <img src="/logo.svg" alt="logo"/>
                </a>

                <h1 className="text-2xl font-bold">Create a Moji account</h1>
                <p className="text-muted-foreground text-balance"> 
                  Welcome to Moji! Please fill in the form below to create your account and start your journey with us.
                </p>
              </div>
              ...
              <div className="text-center text-sm">
                ...
                <a href="/signin" className="font-medium text-primary-glow underline-offset-4 hover:underline">
                  Sign in
                </a>
              </div>
      ...
      <div className="text-xs text-balance px-6 text-center *:[a]:hover:text-primmary text-muted-foreground *:[a]:underline *:[a]:underline-offset-4">
