        ...
        (set,get) => ({
            ...
            fetchMessages: async (conversationId) => {
                ...
                try{
                    ...
                    const processed = fetched.map((m) => {
                        return {
                            ...m,
                            isOwned: m.senderId.toString() === user?._id.toString(),
                        };
                    });
            ...
            addMessage: async (message) => {
                try {
                    ...
                    message.isOwned = message.senderId === user?._id;
            ...
            markAsSeen: async () => {
                try {
                    ...
                    console.error("Error calling mark as seen in store: ", error)   ;
                }
            },
            ...
            createConversation: async (type, name, memberIds) => {
                try {
                    ...
                    console.error("Error calling createConersation: ", error);
                } finally {
                    set({loading: false});
                }
            }
